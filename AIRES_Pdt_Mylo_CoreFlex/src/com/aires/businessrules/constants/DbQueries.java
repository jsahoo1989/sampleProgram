...
public class DbQueries {
	...
	public static final String QUERY_GET_PHONE_TYPE_DROPDOWNLIST = "SELECT PHONE_TYPE_DESC FROM ISISDBA.PHONE_TYPE_CODE order by PHONE_TYPE_DESC";
	public static final String QUERY_GET_EMAIL_TYPE_DROPDOWNLIST = "SELECT EMAIL_TYPE_DESC FROM ISISDBA.EMAIL_TYPE_CODE order by EMAIL_TYPE_DESC";;
