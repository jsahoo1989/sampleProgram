...
public class DbQueries {
	...
	public static final String QUERY_GET_SHIPMENT_SUBSERVICEID = "select * from isisdba.assignment_sub_service  \r\n" + 
			"where\r\n" + 
			" assignment_service_code = 'SHIPMENT' \r\n" + 
			" order by assignment_service_code desc";
	public static final String QUERY_GET_NONSHIPMENT_SUBSERVICEID = " select * from isisdba.assignment_sub_service  \r\n" + 
			"where\r\n" + 
			" assignment_service_code <> 'SHIPMENT' \r\n" + 
			" order by assignment_service_code desc";
