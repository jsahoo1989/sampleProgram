...
public class DbQueries {
	...
	public static final String QUERY_GET_FINAL_MOVE_EXPENSE_CODE = "select EXPENSECODE as EXPENSE_CODE, DESCRIPTION from grossup.expensecodes ec, rmsdba.rms_report_code rrc where rrc.expense_code = ec.expensecode and rrc.BLUEPRINT_CATEGORY_CODE = 'FINALMOVE' and ec.clientid = '999999' order by ec.expensecode";
	public static final String QUERY_GET_HOME_LEAVE_EXPENSE_CODE = "select EXPENSECODE as EXPENSE_CODE, DESCRIPTION from grossup.expensecodes ec, rmsdba.rms_report_code rrc where rrc.expense_code = ec.expensecode and rrc.BLUEPRINT_CATEGORY_CODE = 'HOMELEAVE' and ec.clientid = '999999' order by ec.expensecode";
	public static final String QUERY_GET_ONE_TIME_PAYMENT_EXPENSE_CODE = "select EXPENSECODE as EXPENSE_CODE, DESCRIPTION from grossup.expensecodes ec, rmsdba.rms_report_code rrc where rrc.expense_code = ec.expensecode and rrc.BLUEPRINT_CATEGORY_CODE = 'ONETIMEPAYMENTS' and ec.clientid = '999999' order by ec.expensecode";
}
