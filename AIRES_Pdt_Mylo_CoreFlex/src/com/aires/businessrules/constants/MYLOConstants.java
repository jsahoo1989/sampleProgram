...
public class MYLOConstants {
	...
	public static final String VERIFY_UPDATED_FIELD_VALUE = "{0}Verified Value updated for ''{1}'' field on ''{2}'' section";
	...
	public static final String ORIGIN_DEST = "origin/dest";
	...
	public static final String PHONE_TYPE_COLUMN = "PHONE_TYPE_DESC";
