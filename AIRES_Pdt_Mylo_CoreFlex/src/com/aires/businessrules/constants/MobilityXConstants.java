...
//	public static final String EDIT_BENEFIT_SELECTION = "Edit Benefit Selection";
	...
	public static final String DENIED_DELETE_REQUEST_REMAINING_POINTS_TO_USE_MESSAGE_CLIENT = "You now have current_balance/total_points point(s) to use for TransfereeFN TransfereeLN. If point(s) are remaining, please submit another benefit(s)";
