...
public class MobilityXConstants {
	...
	public static final String ONPOINT_PLANNING_TOOL = "OnPoint Planning Tool";
	...
	public static final String ONPOINT_PLANNING_TOOL_PAGE_NOT_DISPLAYED = "{0} OnPoint planning tool page is not displayed";
...
//	public static final String AUTO_EMAIL_PWD = "Aut0Mati0nT34mFeb";
	...
	public static final String DENIED_DELETE_REQUEST_REMAINING_POINTS_TO_USE_MESSAGE = "You now have current_balance/total_points point(s) to use.";
...
//	public static final String EDIT_BENEFIT_SELECTION = "Edit Benefit Selection";
	...
	public static final String AVAILABLE_POINTS_AFTER_CLIENT_SUBMISSION_TEXT = "Your employer has submitted benefit(s) of spent_points point(s) on your behalf. Your total available point balance is available_points points.";
	...
	public static final String FAILED_TO_VERIFY_MOBILITY_BENEFIT_SUBMISSION_EMAIL = "{0}Failed to verify Mobility Benefit Submission Email.";
	...
	public static final String FAILED_TO_VERIFY_MOBILITY_FLEX_BENEFIT_DELETE_REQUEST_EMAIL = "{0}Failed to verify ''{2}'' Email for - ''{1}'' action.";
	...
	public static final String DENIED_DELETE_REQUEST_REMAINING_POINTS_TO_USE = "Denied Delete Request Remaining Points To Use";
	public static final String DENY_DIALOG_COMMENT = "Deny Dialog Comment Selection";
	public static final String DELETE_REQUEST_BENEFIT = "Delete Request Benefit";
	...
	public static final String SUBMITTED_BENEFITS_SECTION = "Submitted Benefits Section";
	public static final String FAILED_TO_VALIDATE_BENEFIT_SELECTION_TOOL_PAGE_TITLE = "{0}Failed to validate Benefit Selection Tool Page Title.";
	public static final String EXCEPTION_OCCURED_WHILE_VERIFYING_PAGE_TITLE = "{0}Exception occured while verifying ''{2}'' page Title. Exception : ''{1}''.";
	public static final String WINDOW_TITLE = "Window Title";
	public static final String ON_POINT = "OnPoint";
	public static final String SUCCESSFULLY_VERIFIED_WINDOW_TITLE_DISPLAYED_AS_ON_POINT = "{0}Successfully verified window title displayed as OnPoint on ''{1}'' Page.";
	public static final String FAILED_TO_VALIDATE_ONPOINT_PLANNING_TOOL_PAGE_TITLE = "{0}Failed to validate OnPoint Planning Tool Page Title.";
	public static final String AVAILABLE_POINTS_BALANCE_TEXT = "Available Points Balance Text";
	public static final String CLIENT_SUBMISSION = "Client Submission";
	public static final String CLONE_AUTHORIZATION = "Clone authorization";
	public static final String A_DIFFERENT_EMPLOYEE = "A different employee";
	public static final String FAILED_TO_VERIFY_USER_NAVIGATION_TO_CLONE_AUTH_FORM_FIELD_SELECTION_DIALOG = "{0}Failed to verify user navigation to Clone Auth form Field Selection dialog.";
	public static final String CLONE_AUTH_FORM_FIELD_SELECTION_DIALOG = "Clone Auth Form Field Selection Dialog";
	public static final String CLONE_AUTH_FORM_FIELD_SELECTION_DIALOG_HEADING = "Please select fields to be copied to the new authorization form.";
	public static final String SUCCESSFULLY_NAVIGATED_TO_CLONE_AUTH_FORM_FIELD_SELECTION_DIALOG = "{0}Successfully navigated to Clone Auth form Field Selection dialog.";
	public static final String EXCEPTION_OCCURED_WHILE_NAVIGATING_TO_CLONE_AUTH_FORM_FIELD_SELECTION_DIALOG = "{0}Exception occured while navigating to Clone Auth Form Field Selection Dialog. Exception : ''{1}''.";
	public static final String EXCEPTION_OCCURED_WHILE_VERIFYING_CLONE_AUTH_FORM_DIALOG_DEFAULT_POPULATED_FIELD_VALUE = "{0}Exception occured while verifying Clone Auth Form Dialog Default populated - ''{2}'' field value. Exception : ''{1}''";
	...
	public static final String GLOBAL_MOBILITY_ASSESMENT = "Does this authorization require a global mobility assessment?";
	public static final String AIRES_INSTRUCTIONS = "Aires Instructions";
	public static final String COST_ESTIMATE_REQUIRED = "Does this authorization require a cost estimate from Aires?";
	public static final String FAILED_TO_VERIFY_FLEX_BENEFIT_FIELD_DISPLAYED_POST_RELOCATION_POLICY_SELECTION_ON_CLONE_AUTH_FORM_DIALOG = "{0}Failed to verify Flex Benefit field displayed - Post Relocation policy selection on Clone Auth Form Dialog.";
	public static final String EXCEPTION_OCCURED_WHILE_VERIFYING_FLEX_BENEFIT_FIELD_DISPLAYED_POST_RELOCATION_POLICY_SELECTION_ON_CLONE_AUTH_FORM_DIALOG = "{0}Exception occured while verifying Flex Benefit field displayed - Post Relocation policy selection on Clone Auth Form Dialog. Exception : ''{1}''.";
	public static final String FLEX_BENEFITS_CHECKBOX = "Flex Benefits Checkbox";
	public static final String SUCCESSFULLY_VERIFIED_FLEX_BENEFIT_FIELD_DISPLAYED_POST_RELOCATION_POLICY_SELECTION_ON_CLONE_AUTH_FORM_DIALOG = "{0}Successfully verified Flex Benefit field displayed - Post Relocation policy selection on Clone Auth Form Dialog.";
	public static final String FLEX_BENEFIT_FIELD_NOT_DISPLAYED_POST_RELOCATION_POLICY_SELECTION_ON_CLONE_AUTH_FORM_DIALOG = "{0}Flex Benefit field NOT displayed - Post Relocation policy selection on Clone Auth Form Dialog.";
	public static final String REVIEW_AND_SUBMIT = "Review And Submit";
	public static final String FAILED_TO_VERIFY_MOBILITYX_DELEGATE_ACCESS_GRANTED_EMAIL = "{0}Failed to verify MobilityX Delegate Access Granted email.";
	...
	public static final String EXPECTED_ONPOINT_PLANNING_TOOL_APP_CUE_OPTION = "(QA) Transferee Points Overview";
	public static final String ONPOINT_PLANNING_TOOL_APP_CUE_OPTION = "OnPoint Planning Tool Appcue Option";
	public static final String INCREASED_POINTS_DIALOG_NOT_DISPLAYED_ON_AUTHORIZATION_HOME_PAGE = "{0}Increased Points dialog not displayed on Authorization Home page.";
	public static final String TRANSFEREE_EXPECTED_INCREASED_POINTS_MESSAGE = "You are increasing the Total Points to BenefitTP point(s). The employee will see the increased points in MobilityX. Do you want to continue?";
	public static final String CLIENT_EXPECTED_INCREASED_POINTS_MESSAGE = "You are increasing the Total Points to BenefitTP point(s). Do you want to continue?";
	public static final String CLIENT_EXPECTED_INCREASED_POINTS_MESSAGE_BEFORE_TRANSFEREE_ACTIVITY = "You are increasing the Total Points to BenefitTP point(s). The employee will see the increased points in MobilityX. Do you want to continue?";
	public static final String CLIENT_EXPECTED_INCREASED_POINTS_MESSAGE_AFTER_TRANSFEREE_ACTIVITY = "You are increasing the Total Points to BenefitTP point(s). The employee will see the increased points in MobilityX, but benefit selections are no longer available to you due to the employee's activity. Do you want to continue?";
	public static final String SUCCESSFULLY_VERIFIED_SUBMITTED_POINTS_DETAILS_ON_BENEFITS_BUNDLE_PAGE = "{0}Successfully verified submitted points details on Benefits Bundle page";
	public static final String SUBMITTED_POINTS_DETAILS_NOT_MATCHED_ON_BENEFITS_BUNDLE_PAGE = "{0}Submitted points details not matched on Benefits Bundle page.";
	public static final String FAILED_TO_VERIFY_TOTAL_POINTS_VALUE_ON_AUTHORIZATION_FORM = "{0}Failed to verify Total Points values on Authorization Form page.";
	public static final String FAILED_TO_SELECT_CASHOUT_ON_ONPOINT_PLANNING_TOOL_PAGE = "{0}Failed to select Cashout on OnPoint Planning Tool page.";
	public static final String BACK_TO_SEARCH_RESULTS = "Back to search results";
	public static final String FAILED_TO_VERIFY_AND_DISCARD_INCREASED_POINTS_CONFIRMATION_DIALOG_ON_AUTH_FORM_PAGE = "{0}Failed to verify and Discard Increased Points Confirmation Dialog on Auth Form page.";
	public static final String DISCARD_CHANGES_TO_SUBMITTED_AUTHORIZATION_FORM_DIALOG_TEXT = "What would you like to do with the changes to the submitted authorization?";
	public static final String DISCARD_CHANGES_TO_SUBMITTED_AUTHORIZATION_FORM = "Discard Changes to Submitted Authorization Form";
	public static final String SUCCESSFULLY_VERIFIED_AND_DISCARDED_CHANGES_TO_SUBMITTED_AUTHORIZATION_FORM_DIALOG_MESSAGE = "{0}Successfully verified and discarded changes to Submitted Authorization Form Dialog.";
	public static final String DISCARD_CHANGES_TO_SUBMITTED_AUTHORIZATION_FORM_DIALOG_NOT_DISPLAYED_ON_AUTHORIZATION_HOME_PAGE = "{0}Discard Changes to Submitted Authorization Form dialog not displayed on Authorization Home page.";
	public static final String EXCEPTION_OCCURED_WHILE_VALIDATING_DISCARD_CHANGES_TO_SUBMITTED_AUTHORIZATION_FORM_DIALOG = "{0}Exception occured while validating Discard Changes to Submitted Authorization Form dialog message. Exception : ''{1}''.";
	public static final String AVAILABLE_POINTS_AFTER_CLIENT_SUBMISSION_TEXT_BEFORE_TRANSFEREE_ACTIVITY = "Congratulations on your upcoming Mobility Journey!Your employer has submitted benefit(s) of spent_points point(s) on your behalf. Your total available point balance is available_points points.";
	public static final String AVAILABLE_POINTS_AFTER_CLIENT_SUBMISSION_TEXT_AFTER_TRANSFEREE_ACTIVITY = "Congratulations on your upcoming Mobility Journey!Your total available point balance is available_points points.";
	public static final String CORE_BENEFIT_TRANSFEREE_SECTION = "Core Benefit Transferee Section Header Text";
	public static final String EXCEPTION_OCCURED_WHILE_VALIDATING_CORE_BENEFIT_SECTION_HEADER_ON_ONPOINT_PLANNING_TOOL_PAGE = "{0}Exception occured while Validating Core Benefit Section Header on OnPoint Planning Tool page. Exception : ''{1}''.";
