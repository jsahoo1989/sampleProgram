...
public class MobilityXConstants {
	...
	public static final String SUCCESSFULLY_REVIEWED_AND_SUBMITTED_BENEFITS_ON_MY_BUNDLE_PAGE = "{0}Successfully reviewed and submitted benefits on my bundle page";
	public static final String EXCEPTION_OCCURED_WHILE_REVIEWING_AND_SUBMITTING_BENEFITS_ON_MY_BUNDLE_PAGE = "{0} Exception occured while reviewing and submitting benefit details on My Bundle Page. Exception - ''{1}''.";
	...
	public static final String SUBMIT_BUNDLE_POPUP_NOT_DISPLAYED = "Submit bundle popup not displayed";
	...
	public static final String EXCEPTION_OCCURED_WHILE_VALIDATING_AND_SELECTING_PORTION_CASHOUT_ON_FLEX_PLANNING_TOOL_PAGE = "{0}Exception occured while validating and selecting Portion Cashout on Flex Planning Tool Page. Exception : ''{1}''.";
	public static final String SUCCESSFULLY_VERIFIED_AND_SELECTED_PORTION_CASHOUT_ON_FLEX_PLANNING_TOOL_PAGE = "{0}Successfully verified and selected portion cashout details on Flex Planning Tool Page.";
