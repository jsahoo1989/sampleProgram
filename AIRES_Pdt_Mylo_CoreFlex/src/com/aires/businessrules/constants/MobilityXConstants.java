...
public class MobilityXConstants {
	...
	public static final String INITIATION_SUBMISSION_BENEFIT_TOTAL_POINTS = "Initiation Submission Benefit Total Points";
	...
	public static final String EXPECTED_INCREASED_POINTS_MESSAGE = "You are increasing the Total Points to BenefitTP point(s). The transferee will see the increased points in MobilityX. Do you want to continue?";
