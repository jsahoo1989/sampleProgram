...
public class PDTConstants {
	...
	public static final String SET_OF_DAYS = "Set # of days";
	...
	public static final String BUSINESS_CLASS_AIRFARE = "Business Class Airfare";
	public static final String MIN_DISTANCE_FOR_ECONOMY_AIR_TRAVEL = "Min. Distance for Economy Air Travel";
	public static final String BUSINESS_CLASS_AIRFARE_UNIT = "Business Class Airfare Unit";
	public static final String HOURS = "Hours";
	public static final String MIN_DISTANCE_FOR_BUSINESS_AIR_TRAVEL = "Min. Distance for Business Air Travel";
	public static final String MIN_TIME_FOR_BUSINESS_AIR_TRAVEL_IN_HOURS = "Min. Time for Business Air Travel - In Hours";
	public static final String OTHER_SEE_TRAVEL_POLICY = "Other - see travel policy";
	public static final String VRFIED_ELE_TYPE_ON_PAGE = "{0} Verified {1} - ''{2}'' is Present On Page ";
	public static final String VRFIED_ELE_TYPE_NOT_ON_PAGE = "<font color=''red''>{0} Failed to verify {1} - ''{2}'' is Present On Page.</font>";
	public static final String VRFIED_ELE_TYPE_NOT_AVAILABLE = "{0} Failed to verify {1} - ''{2}'' is Present On Page.";
	public static final String LABEL = "Label";
	public static final String TEXTBOX = "Textbox";
	public static final String RADIOBTN = "Radio btn";
	public static final String VERIFIED_FIELD_FOR_MAX_CHARACTERS = "{0}Verified {1} field is accepting {2} characters. Actual text={3}. Expected text= {4}.";
	public static final String VERIFIED_FIELD_NOT_ACCEPTING_ALL_ENTERED_CHARACTERS = "{0}Verified {1} field is accepting {2} characters and not {3} characters. Actual text = {4}. Expected text = {5}.";
	public static final String FAILED_TO_VERIFY_FIELD_ACCEPTING_MAX_CHARACTERS = "<font color='red'>{0}Failed to verify ''{1}'' field is accepting max {2} characters. Actual text = {3}. Expected text = {4}.</font>";
	public static final String FAILED_TO_VERIFY_FIELD_ACCEPTING_MAX_CHAR = "{0}Failed to verify ''{1}'' field is accepting max {2} characters. Actual text = {3}. Expected text = {4}.";
	public static final String DRAFT_ERR = "Draft error";
	public static final String VERIFY_TEXT_MESSAGE = "{0} Actual Text = ''{1}'' Expected Text = ''{2}''";
	public static final String ELEVEN_DIGIT_STRING = "98765987645";
	public static final String FOUR_DIGIT_STRING = "9876";
	public static final String MAX_LENGTH_FOR_BUS_AIR_TRAVEL_INHRS = "3";
