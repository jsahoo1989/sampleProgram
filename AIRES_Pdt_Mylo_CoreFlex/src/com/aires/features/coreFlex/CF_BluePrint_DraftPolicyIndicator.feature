Feature: Validate the Complete/InComplete Draft policy Indicator feature of Points Based CoreFlex policy in BluePrint Application
  ...
  @End-To-End_CoreFlex @CF_BluePrint_DraftPolicyIndicator @CF_BluePrint_DraftPolicyIndicator_CloningDraftInComplete
  ...
  @End-To-End_CoreFlex @CF_BluePrint_DraftPolicyIndicator @CF_BluePrint_DraftPolicyIndicator_CloningDraftComplete
  ...
  @End-To-End_CoreFlex @CF_BluePrint_DraftPolicyIndicator @DPI_SubmittedPolicyDataCreationSignificantChange_PS
  Scenario: CoreFlex - Creating a new Submitted Status policy as a part of Data Creation activity to validate Significant Change Functionality
    Given he has setup a new Points Based CoreFlex Policy with following selection in Blueprint application
      ...
      | Transferee                               | Static/Fixed    | Portion Cashout      | Flex        | Client            |
  ...
  @End-To-End_CoreFlex @CF_BluePrint_DraftPolicyIndicator @DPI_AddBenefit_SubmittedToDraft
