Feature: Validate Assignment History Feature of Points based CoreFlex policy that has one or more assignments/files for BluePrint Enabled Client
  ...
  @End-To_End_CoreFlex @Versioning_AssignmentHistory @AssignmentHistoryIconEnabledDisabledStatusCheck
  ...
  @End-To_End_CoreFlex @Versioning_AssignmentHistory @ActiveStatusPolicyCreationAssignmentHistory
  ...
  @End-To_End_CoreFlex @Versioning_AssignmentHistory @AssignmentHistoryDataNotAvailableCheck
  ...
  @End-To_End_CoreFlex @Versioning_AssignmentHistory @AssignmentHistoryDataVerification
