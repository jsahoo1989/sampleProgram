Feature: Validate Versioning Feature of Points based CoreFlex policy that has one or more assignments/files for BluePrint Enabled Clients

  @End-To_End_CoreFlex @CF_BluePrint_Versioning @Version1ActivePolicy @Versioning_NewWF_Check
  ...
  @End-To_End_CoreFlex @CF_BluePrint_Versioning @BluePrintNewVersionPolicyBenefitSelectionCheck @Versioning_NewWF_Check
