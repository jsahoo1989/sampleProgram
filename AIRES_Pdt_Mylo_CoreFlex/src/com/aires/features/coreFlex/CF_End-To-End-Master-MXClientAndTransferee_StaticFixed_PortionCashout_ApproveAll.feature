Feature: Validate the OnPoint End-To-End Business Test Flow(BluePrint, MXClientAndTransferee, Transferee Submissions) for Both_MXClientAndTransferee_StaticFixed_PortionCashout_Delete_ApproveAll selection

  @OnPoint_Regression @CF_End-To-End_MasterScript @CF_Master_ClientAndTransferee_PortionCashout_ApproveAll @CF_Master_ClientAndTransferee_PortionCashout_ApproveAll_PS
  ...
  @OnPoint_Regression @CF_End-To-End_MasterScript @CF_Master_ClientAndTransferee_PortionCashout_ApproveAll @CF_Master_ClientAndTransferee_PortionCashout_ApproveAll_CF1
  ...
  @OnPoint_Regression @CF_End-To-End_MasterScript @CF_Master_ClientAndTransferee_PortionCashout_ApproveAll @CF_Master_ClientAndTransferee_PortionCashout_ApproveAll_TF
  ...
  @OnPoint_Regression @CF_End-To-End_MasterScript @CF_Master_ClientAndTransferee_PortionCashout_ApproveAll @CF_Master_ClientAndTransferee_PortionCashout_ApproveAll_CF2
