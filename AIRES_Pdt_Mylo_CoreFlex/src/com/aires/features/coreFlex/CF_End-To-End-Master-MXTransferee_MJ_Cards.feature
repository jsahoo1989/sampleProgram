Feature: Validate Transferee Mobility Journey Cards & Aires Managed Benefits - Submitted, StartingSoon, InProgress, Complete & Canceled Status 
  ...
  @Coreflex:218310 @CF_End-To-End_MasterScript @CF_Master_Transferee_Cards @CF_Master_Transferee_Cards_PolicySetup
  ...
  @Coreflex:218329 @CF_End-To-End_MasterScript @CF_Master_Transferee_Cards @CF_Master_MobilityJourneyCards_StatusCheck
  ...
  @Coreflex:218335 @CF_End-To-End_MasterScript @CF_Master_Transferee_Cards @CF_Master_MobilityJourneyCards_CancelledStatusCheck
