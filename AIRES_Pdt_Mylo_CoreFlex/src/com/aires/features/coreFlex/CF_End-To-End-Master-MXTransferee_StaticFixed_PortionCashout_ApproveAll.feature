Feature: Validate MXTransferee Workflow for Transferee-PortionCashout selection, CloningToDifferentClient, Transferee Mobility Journey, PortionCashout and Transferee Submissions ApproveAll Operation
  ...
  @OnPoint_Regression @CF_End-To-End_MasterScript @CF_Master_Transferee_PortionApprove @CF_Master_PortionApprove_PolicySetup
  ...
  @OnPoint_Regression @CF_End-To-End_MasterScript @CF_Master_Transferee_PortionApproveIgnore @CF_Master_PortionApprove_CloningToDifferentClientPolicy
  ...
  @OnPoint_Regression @CF_End-To-End_MasterScript @CF_Master_Transferee_PortionApprove @CF_Master_PortionApprove_MXTransfereeFlow
  Scenario: MXTransferee - Submitting Flex benefits_PortionCashout available in configured policy and Validating Available_Used Benefits Points and Cashout Post Delete Operation
    ...
    And he has verified 'Portion Cashout' details on "OnPoint Planning Tool" page
  ...
  @OnPoint_Regression @CF_End-To-End_MasterScript @CF_Master_Transferee_PortionApprove @CF_Master_PortionApprove_MSPEC_PPC_Flow
  Scenario: TransfereeSubmissions - Verifying Benefit_Cashout_Points and History Details in TransfereeSubmissions & MobilityX application post Approve All Delete request selection by MSPEC/PPC User
