Feature: Validate the MXClient Auth Form Sequential-ApprovalWF and CoreFlex End-To-End Business Test Flow(BluePrint, MXClient, Transferee Submissions) for Both_MXClient_UserDefined_PortionCashout_Delete_DenyAll selection
  ...
  @OnPoint_Regression @CF_OnPoint_Feature @CF_MXClient_ApprovalWF_Sequential_UserDefined_PortionCashout @CF_MXClient_ApprovalWF_Sequential_UserDefined_PortionCashout_PS
  ...
  @OnPoint_Regression @CF_OnPoint_Feature @CF_MXClient_ApprovalWF_Sequential_UserDefined_PortionCashout @CF_MXClient_ApprovalWF_Sequential_UserDefined_PortionCashout_AF1
  ...
  @OnPoint_Regression @CF_OnPoint_Feature @CF_MXClient_ApprovalWF_Sequential_UserDefined_PortionCashout @CF_MXClient_ApprovalWF_Sequential_UserDefined_PortionCashout_AF2
  ...
  @OnPoint_Regression @CF_OnPoint_Feature @CF_MXClient_ApprovalWF_Sequential_UserDefined_PortionCashout @CF_MXClient_ApprovalWF_Sequential_UserDefined_PortionCashout_CF2
  ...
  @OnPoint_Regression @CF_OnPoint_Feature @CF_MXClient_ApprovalWF_Sequential_UserDefined_PortionCashout @CF_MXClient_ApprovalWF_Sequential_UserDefined_PortionCashout_TS
