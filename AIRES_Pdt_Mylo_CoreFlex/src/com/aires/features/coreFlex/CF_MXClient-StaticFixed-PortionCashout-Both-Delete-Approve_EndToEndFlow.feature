Feature: Validate the CoreFlex End-To-End Business Test Flow(BluePrint, MXClient, Transferee Submissions) for Both_MXClient_StaticFixed_PortionCashout_Delete_DenyAll selection

  @End-To-End_CoreFlex @CF_MXClient_StaticFixed_PortionCashout
  Scenario: CoreFlex - Creating & Validating a new Active Points Based CoreFlex Policy with MXClient, StaticFixed and PortionCahout selection
    Given he has setup a new CoreFlex Policy with following selection in Blueprint application
      ...
      | Client Initiator                         | Static/Fixed    | Portion Cashout      | Both        | Client            |          0 |
  ...
  @End-To-End_CoreFlex @CF_MXClient_StaticFixed_PortionCashout
  Scenario: MXClient - Validating Total Points Section, Core/Flex benefits & PortionCashout displayed on BenefitSelectionTool page for Client Initiator BluePrint Policy Setup
    ...
    And he has verified 'Total Points' section displayed on 'Authorization Form' for "Static/Fixed" - 'Flex Setup Type' selection in BluePrint CoreFlex Policy
  ...
  @End-To_End_CoreFlex @CF_MXClient_StaticFixed_PortionCashout
