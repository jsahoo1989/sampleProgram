Feature: Validate the CoreFlex End-To-End Business Test Flow(BluePrint, MXClient, Transferee Submissions) for Both_MXClient_UserDefined_AfterRelocation_Delete_ApproveAll selection
  ...
  @End-To-End_CoreFlex @CF_MXClient_UserDefined_AfterRelocation_Delete_Approve
  Scenario: CoreFlex - Creating & Validating a new Active Points Based CoreFlex Policy with MXClient, UserDefined and AfterRelocation selection
    Given he has setup a new Points Based CoreFlex Policy with following selection in Blueprint application
      ...
      | Client Initiator                         | User Defined    | After Relocation Only | Both        | Client            |          0 |
  ...
  @End-To_End_CoreFlex @CF_MXClient_UserDefined_AfterRelocation_Delete_Approve 
