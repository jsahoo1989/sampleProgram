Feature: Validate the CoreFlex End-To-End Business Test Flow(BluePrint, MXClient, Transferee Submissions) for Both_MXClient_UserDefined_CashoutNotAuthorized_Delete_ApproveAll selection
  ...
  @End-To-End_CoreFlex @CF_MXClient_UserDefined_CashNotAuth @Test12765
  Scenario: MXClient - Validating Total Points Section & Core/Flex benefits displayed on BenefitSelectionTool page for Client Initiator BluePrint Policy Setup
    ...
    And he has verified following details on "Benefit Selesction Tool" page based on configured Points Based CoreFlex BluePrint Policy
      | Available Point Balance | Core Benefits | Flex Benefits | Suggested Bundles | Cashout |
    And he has clicked on 'Back to benefits list' link on 'Suggested Bundles' to navigate to 'Benefit Selection Tool' page
  ...
  @End-To_End_CoreFlex @CF_MXTransferee_UserDefined_CashNotAuth @Test12765
