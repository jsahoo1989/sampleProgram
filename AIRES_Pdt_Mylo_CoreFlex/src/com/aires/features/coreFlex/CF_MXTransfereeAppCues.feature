Feature: Validate the AppCues displayed for OnPoint Policy configuration for Transferee user on MobilityX application
  ...
  @CF_End-To-End_MasterScript @CF_MXTransfereeAppCues @CF_MXTransfereeAppCues_Transf_PolicySetup
  Scenario: CoreFlex - Creating a new Active Points Based CoreFlex Policy for MXTransferee AppCues Verification
  ...
  @CF_End-To-End_MasterScript @CF_MXTransfereeAppCues @CF_MXTransfereeAppCues_TF_AllAppCues
  ...
  @CF_End-To-End_MasterScript @CF_MXTransfereeAppCues @CF_MXTransfereeAppCues_ClientTransf_PolicySetup
  Scenario: CoreFlex - Creating a new Active Points Based CoreFlex Policy for MXTransferee AppCues Verification
    Given he has setup a new Points Based CoreFlex Policy with following selection in Blueprint application
      | Person Responsible For Benefit Selection | Flex Setup Type | Cashout Availability   | BenefitType | PolicyRequiredFor |
  ...
  @CF_End-To-End_MasterScript @CF_MXTransfereeAppCues @CF_MXTransfereeAppCues_ClientTransf_CWF
  ...
  @CF_End-To-End_MasterScript @CF_MXTransfereeAppCues @CF_MXTransfereeAppCues_ClientTransf_TWF
  Scenario: MXTransferee - Validating Selection & Submission of Flex benefits available in Client configured policy and Tracking Available_Used Benefits Points
    ...
    And he has clicked on '?' displayed on top right corner besides 'Resources' dropdown
    When he clicks on "(QA) Transferee Points MobilityX Overview" option displayed under 'Get Help' section
