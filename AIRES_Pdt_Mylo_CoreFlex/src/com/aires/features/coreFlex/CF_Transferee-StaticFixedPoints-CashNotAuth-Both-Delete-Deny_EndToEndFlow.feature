...
@PolicySetupFlow1 @Both-CashNotAuth_DenyRequest_PF
...
@MXTransfereeFlow @Both-CashNotAuth_DenyRequest_MX
...
@TransfereeSubmissionFlow @Both-CashNotAuth_DenyRequest_MX
Scenario: TransfereeSubmissions - Verifying_Approving_Denying submissions made by Transferee for the Client(s) assigned to PPC User 
	...
	And benefit details should be updated on 'MXTransferee' application based on "Denied" 'Delete Request' on Transferee Submission