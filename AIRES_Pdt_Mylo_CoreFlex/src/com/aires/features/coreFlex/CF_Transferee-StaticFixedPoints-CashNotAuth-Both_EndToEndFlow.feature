Feature: Validate the CoreFlex End-To-End Business Test Flow(BluePrint, MXTransferee,Transferee Submissions) for Both_Transferee_StaticFixed_CashoutNotAuthorized_Delete_ApproveAll selection

  @End-To-End_CoreFlex @CF_MXTransferee_StaticFixed_CashNotAuth @Test889
  ...
  @End-To-End_CoreFlex @CF_MXTransferee_StaticFixed_CashNotAuth
  ...
  @End-To-End_CoreFlex @CF_MXTransferee_StaticFixed_CashNotAuth
  Scenario: TransfereeSubmissions - Verifying StaticFixed Points, BenefitSubmissions and Delete Request ApprovalAll transaction for the request made by the Transferee
