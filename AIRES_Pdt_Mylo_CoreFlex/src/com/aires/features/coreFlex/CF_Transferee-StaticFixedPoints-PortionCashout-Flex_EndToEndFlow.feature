...
@PolicySetupFlow @Flex-PortionCashout_PF
...
##    And he has created a payment account to credit portion cashout amount
...
#    And he has navigated to "FleX Planning Tool" page with configured "Flex" Type Policy-Benefits details
...
#    And point balance details should be upadted on "Flex Planning Tool" page
#    And submitted benefit details should be present on "My Benefits Bundle" page
#
#@Flex-PortionCashout
