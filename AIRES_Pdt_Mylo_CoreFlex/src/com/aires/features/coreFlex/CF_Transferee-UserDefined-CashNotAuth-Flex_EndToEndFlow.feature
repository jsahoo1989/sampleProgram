Feature: Validate the CoreFlex End-To-End Business Test Flow(BluePrint, MXTransferee,Transferee Submissions) for Flex_Transferee_UserDefined_CashoutNotAuthorized Policy selection

  @End-To_End_CoreFlex @CF_Transf_UserDef_CashNotAuth_PF
  Scenario: CoreFlex - Setting up a New CoreFlex policy in 'BluePrint' application
    Given he has setup a new CoreFlex Policy with following selection in Blueprint application
      ...
      | Transferee                               | User Defined    | Cashout Not Authorized | Flex        | Cloning           |          0 |
  ...
  @End-To_End_CoreFlex @CF_Transf_UserDef_CashNotAuth_MX
