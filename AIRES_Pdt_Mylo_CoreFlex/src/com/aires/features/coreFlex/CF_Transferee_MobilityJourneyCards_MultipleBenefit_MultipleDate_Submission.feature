Feature: Validate the Mobility Journey Aires Managed Benefits Cards Functionality for Multiple Benefit & Multiple Date Benefit Submission on MobilityX Application.
  ...
  @End-To_End_CoreFlex @MJ_Cards_PolicyDataSetup  @AllCards
  ...
  Scenario: MXTransferee - Verifying Mobility Journey Both Card details for submitted Both type Aires Managed benefits
    ...
    And he has navigated to "My Benefits Bundle" page after validating and selecting 'Aires Managed' benefit for 'Multiple Date Submission' on "FleX Planning Tool" page
    ...
    And he has clicked on "Yes - submit my bundle" button after entering Transferee name on "Submit Bundle Confirmation" dialog to submit Selected Benefits
    And he has verified submitted Aires Managed Benefit status for 'Multiple Submission' updated to "Submitted" on "My Benefit Bundle" page
    And he has verified 'Aires Managed' benefit card not added under 'Service Monitoring' section of "Mobility Journey Home" page
    And he has created Service and SubService for 'Aires Managed' benefits of CoreFlex type "Both" for 'Multiple Submission' in Services tab of IRIS application
    And he has verified submitted Benefits Flex and Core card status updated to "Starting Soon" on "Mobility Journey Home" page - "Pre Initial Tracing"
