...
@IRIS-731 @Mylo-Regression
Scenario Outline:  Mylo-Validate Cancel/Save operation in  Mylo Assignment File Information section
...
When he clicks on the "<ButtonName>" under file information
...
When he clicks on the "Save" under file information
...
And "evip" checkbox is automatically unchecked after he unchecks the "vip" box 
...
And a warning message "<WarningMsg>" displayed after he clicks "ls" check box
When he clicks on the "Yes" under file information
...
@IRIS-776 @Mylo-Regression
Scenario Outline:  Mylo-Validate Select One option available in dropdown fields of Mylo Assignment File Information section
...
Then "Select One" should display in the list of values of the "<FieldName>"  dropdown
Examples:
|FieldName|
|Policy Type|
|Transfer Type|
