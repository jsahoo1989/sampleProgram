...
Given he is on "Add Partner" section after clicking on 'Add' link displayed in right panel under "Transferee and Family" section for  "activeAssignment" fileID
...
Given he is on Partner section after clicking on "Partner Dropdown arrow" displayed in right panel under "Transferee and Family" section for "transfereeMemberDetails" fileID
...
Given he is on Partner section after clicking on "Partner Dropdown arrow" displayed in right panel under "Transferee and Family" section for "transfereeAllMemberDetails" fileID
...
Given he is on Partner section after clicking on "Partner Dropdown arrow" displayed in right panel under "Transferee and Family" section for "relocationPolicyType" fileID
