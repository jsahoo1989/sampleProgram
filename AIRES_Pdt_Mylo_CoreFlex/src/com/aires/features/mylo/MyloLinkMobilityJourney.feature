Feature: Validate the functionality of Mylo Link/Mobility Journey Section
  ...
  Scenario: MX_Mylo- Validate "link/Mobility Journey" popup on Mylo application with different UserTypes for same Transferee Name files created on MobilityX application
  ...
  @MYLO2-258 @218577 @218580 @218586 
  ...
  @MYLO2-2581 @218583 @218584 @218585 
  ...
  @MYLO2-258 @218587 @218588 @218582 
  ...
  @MYLO2-258 @218579 @218581 
  Scenario: Mylo- Validate "Same Person, Link As A New Journey" and "Different person, do not wish to link" behavior on "link/Mobility Journey" on Mylo application
    Given he has created a new file with existing transferee name on Mylo application logged in with user type "With Resource100008"
