Feature: Validate the functionality of Mylo Transferee Name Query
  ...
  Background: Login to  Mylo application and navigate to Query By Transferee Name section
    Given he has logged into the 'Mylo' application

  @Mylo2-157 @218528 @218529 @218530 @Mylo-Regression
  Scenario Outline: Mylo-Validate Search Results for valid inputs of different fields on Query By Transferee Name section
    Given he is on "Query By Transferee's Name" popup by selecting "Transferee Name" option available on "Query" section
    When he clicks on "Execute" button after entering "<First Name>" with "<Last Name>" on 'Query By Transferee Name' popup
    Then related files should get appear into the query result modal as per the selected "<First Name>" with "<Last Name>"
  ...
  @Mylo2-157 @218531 @218532 @218533 @218535 @Mylo-Regression
  ...
  @Mylo2-157 @218534 @218536 @Mylo-Regression
  Scenario: Mylo-Validate Warning Toast Message on Mandatory Field to enter & Cancel button functionality in Mylo Query By Transferee Name section
    Given he is on "Query By Transferee's Name" popup by selecting "Transferee Name" option available on "Query" section
    When he views 'Query By Transferee Name' section
  ...
  @Mylo2-157 @218537 @Mylo-Regression
  ...
  @Mylo2-157 @218538 @Mylo-Regression
