...
public class CoreFlex_AreaTour_BenefitsPage extends BenefitPage {
	...
	@FindBy(how = How.XPATH, using = "//h4[@class='card-title'][contains(text(),'Area Tour')]")
	...
	public void selectAndFillBenefitsAndSubBenefitDetails(String benefitType, String subBenefitNames,
		...
		CoreFunctions.explicitWaitTillElementVisibility(driver, _headerPageName,
				COREFLEXConstants.AREA_TOUR_BENEFITS_PAGE);
