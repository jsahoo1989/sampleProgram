...
public class CoreFlex_FurnitureRental_BenefitsPage extends Base {
	...
	CoreFlex_SettlingInBenefitsData settlingInBenefitData = FileReaderManager.getInstance()
			.getCoreFlexJsonReader().getSettlingInBenefitDataList(COREFLEXConstants.FURNITURE_RENTAL);
	...
	public boolean verifyPageNavigation(String expectedPageName) {
		return CoreFunctions.verifyElementOnPage(driver, _headerPage, COREFLEXConstants.FURNITURE_RENTAL, expectedPageName,
	...
	private void fillFurnitureRentalSubBenefitForm(String subBenefitFormName) {
		try {
			...
			CoreFunctions.clearAndSetText(driver, _txtAreaComment,
					settlingInBenefitData.furnitureRental.comment);
	...
	private void selectBenefitTypeAndFillMandatoryFields(String benefitType, String multipleBenefitSelection,
		...
		case COREFLEXConstants.CORE:
			...
			fillManadatoryDetails(benefitType, multipleBenefitSelection,
					...
					furnitureRentalBenefit.getBenefitDesc(), aireManagedService);
			break;
