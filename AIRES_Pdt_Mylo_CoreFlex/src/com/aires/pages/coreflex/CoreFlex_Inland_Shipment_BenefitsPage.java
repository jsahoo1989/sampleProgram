	...
	private void verifyBenefitsMandatoryDetails(String benefitType, String multipleBenefitSelection, String flexPoints,
		...
		case COREFLEXConstants.CORE:
			...
			verifyManadatoryDetails(benefitType, multipleBenefitSelection,
					inlandShipmentBenefit.getBenefitDisplayName(), inlandShipmentBenefit.getBenefitAmount(),
					inlandShipmentBenefit.getBenefitDesc(), paymentOption, airesManagedService);
			break;
		case COREFLEXConstants.FLEX:
			CoreFunctions.clickElement(driver, _textFlex);
...
//			}
	...
	/**
	 * Method to verify InlandShipment subBenefit form
	 */
	private void verifyInlandShipmentSubBenefitForm(String formName) {
		try {
			...
			CoreFunctions.verifyRadioButtonSelection(driver, _radioInsuranceType, _radioInsuranceTypeButtonList,
					inlandShipmentBenefitData.inlandShipment.insuranceType, COREFLEXConstants.INSURANCE_TYPE);
			if (inlandShipmentBenefitData.inlandShipment.insuranceType.equalsIgnoreCase(COREFLEXConstants.OTHER)) {
			...
			CoreFunctions.verifyRadioButtonSelection(driver, _radioBtnGrossUp, _radioBtnGrossUpButtonList,
					inlandShipmentBenefitData.inlandShipment.grossUp, COREFLEXConstants.GROSS_UP);
			CoreFunctions.verifyRadioButtonSelection(driver, _radioReimbursedBy, _radioReimbursedByButtonList,
					inlandShipmentBenefitData.inlandShipment.reimbursedBy, COREFLEXConstants.REIMBURSED_BY);
			if (inlandShipmentBenefitData.inlandShipment.reimbursedBy.equalsIgnoreCase(COREFLEXConstants.OTHER)) {
			...
			CoreFunctions.verifyText(_txtAreaComment.getDomProperty("value"),
					inlandShipmentBenefitData.inlandShipment.comment, COREFLEXConstants.COMMENT);
