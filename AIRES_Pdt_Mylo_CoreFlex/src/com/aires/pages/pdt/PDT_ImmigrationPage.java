...
public class PDT_ImmigrationPage extends PDT_SharedSubBenefitPage {
	...
	@FindBy(how = How.CSS, using = "ng-select[formcontrolname='immigratFeeExpenseCodeList'] span.ng-value-label")
	...
	@FindBy(how = How.CSS, using = "ng-select[formcontrolname='immigratTravelExpenseCodeList'] span.ng-value-label")
