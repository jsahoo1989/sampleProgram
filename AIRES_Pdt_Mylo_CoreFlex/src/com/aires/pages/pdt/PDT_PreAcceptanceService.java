...
public class PDT_PreAcceptanceService extends PDT_SharedSubBenefitPage {
	...
	private WebElement _headingFormPreTripRentalCar;
	...
	private WebElement _formHeaderPreAcceptanceTripRentalCar;
	...
	@FindBy(how = How.XPATH, using = "//app-pre-acceptance//input[@formcontrolname='grossedUpInd']/parent::label")
	...
	@FindBy(how = How.CSS, using = "ng-select[formcontrolname='preAcceptanceCandidateSelectionExpenseCodeList'] span.ng-value-label")
	...
	@FindBy(how = How.CSS, using = "ng-select[formcontrolname='preAcceptanceTransportationExpenseCodeList'] span.ng-value-label")
	...
	@FindBy(how = How.CSS, using = "ng-select[formcontrolname='preAcceptanceLodgingExpenseCodeList'] span.ng-value-label")
	...
	@FindBy(how = How.CSS, using = "ng-select[formcontrolname='preAcceptanceMealsExpenseCodeList'] span.ng-value-label")
	...
	@FindBy(how = How.XPATH, using = "//ng-select[@formcontrolname='unitOfEconomyCode']/preceding-sibling::label")
	private WebElement _lblEconomyClassAirFareUnit;
	
	@FindBy(how = How.CSS, using = "ng-select[formcontrolname='unitOfEconomyCode']")
	private WebElement _drpDownEconomyClassAirfareUnit;

	@FindBy(how = How.CSS, using = "ng-select[formcontrolname='unitOfEconomyCode'] span.ng-value-label")
	...
	@FindBy(how = How.XPATH, using = "//input[@formcontrolname='minTimeEconomy']/preceding-sibling::label")
	private WebElement _lblMinTimeForEconomyAirTravel;

	@FindBy(how = How.CSS, using = "input[formcontrolname='minTimeEconomy']")
	private WebElement _txtBoxMinTimeForEconomyAirTravel;
	
	@FindBy(how = How.CSS, using = "app-pre-trip-rental-car input[formcontrolname='numOfDays']")
	private WebElement _txtBoxDurationTripRentalCar;
	
	@FindBy(how = How.XPATH, using = "//app-pre-trip-rental-car//input[@formcontrolname='numOfDays']/preceding-sibling::label")
	...
	@FindBy(how = How.CSS, using = "#collapseFive label.form-check-label")
	private List<WebElement> _radioBtnPreTripRentalCar;
	
	@FindBy(how = How.XPATH, using = "//app-pre-trip-rental-car//input[@formcontrolname='grossedUpInd']/parent::label")
	private List<WebElement> _radioBtnGrossUpPreTripRentalCar;
	
	@FindBy(how = How.XPATH, using = "//app-pre-trip-rental-car//input[@formcontrolname='paidByCode']/parent::label")
	private List<WebElement> _radioBtnReimbursedByPreTripRentalCar;
	
	@FindBy(how = How.CSS, using = "app-pre-trip-rental-car input[formcontrolname='paidByOther']")
	private WebElement _txtBoxReimbursedByOtherPreTripRentalCar;
	
	@FindBy(how = How.CSS, using = "app-pre-trip-rental-car textarea[formcontrolname='benefitComment']")
	private WebElement _textAreaBenefitCommentTripRentalCar;
	
	@FindBy(how = How.CSS, using = "ng-select[formcontrolname='preAcceptanceRentalCarExpenseCodeList']")
	private WebElement _drpDownRentalCarExpenseCode;

	@FindBy(how = How.CSS, using = "ng-select[formcontrolname='preAcceptanceRentalCarExpenseCodeList'] span.ng-value-label")
	...
	private String _accompanyingFamilyMemeber, _maxAmtPreAcceptTripLodging, _maxAmtPreAcceptTripMeals, _sizeClass;
	...
	public void populateSubBenefitHeaderMap() {
		...
		subBenefitHeaderMap.put(PDTConstants.PRE_ACCEPTANCE_TRIP_RENTAL_CAR, _formHeaderPreAcceptanceTripRentalCar);
	}
	...
	public void fillSubBenefitForm(String subBenefit, String pageName, PDT_AddNewPolicyPage addNewPolicyPage,
		...
		case PDTConstants.PRE_ACCEPTANCE_TRIP_MEALS:
			...
			break;
		case PDTConstants.PRE_ACCEPTANCE_TRIP_RENTAL_CAR:
			fillPreAcceptanceTripRentalCar(addNewPolicyPage, subBenefit, pageName, objStep);
			break;
		default:
			Assert.fail(
	...
	public void verifyAndFillEconomyAirTravelFieldText(PDT_SharedSubBenefit_Steps sharedSubBenefitStep) {
		try {
			if (CoreFunctions.getElementTextAndStoreInList(driver, _drpDownTransportationTypeSelectedOptions)
	...
	public void fillPreAcceptanceTripRentalCar(PDT_AddNewPolicyPage addNewPolicyPage, String subBenefitFormName,
		...
		try {
			...
			BusinessFunctions.verifyOtherTextBoxIsDisplayed(driver,
					preAcceptanceSubBenefitData.preAcceptanceTripRentalCar.sizeClass,
					_txtBoxOtherSizeClass,
					preAcceptanceSubBenefitData.preAcceptanceTripRentalCar.otherSizeClass, subBenefitFormName,
					PDTConstants.REIMBURSED_BY_OTHER);
			...
			CoreFunctions.selectItemInListByText(driver, _radioBtnGrossUpPreTripRentalCar,
					preAcceptanceSubBenefitData.preAcceptanceTripRentalCar.grossUp, PDTConstants.GROSS_UP,
					PDTConstants.RADIO_BUTTON_LIST, true);
			
			
			CoreFunctions.selectItemInListByText(driver, _radioBtnReimbursedByPreTripRentalCar,
					preAcceptanceSubBenefitData.preAcceptanceTripRentalCar.reimbursedBy,
					PDTConstants.REIMBURSED_BY, PDTConstants.RADIO_BUTTON_LIST, true);

			BusinessFunctions.verifyOtherTextBoxIsDisplayed(driver,
					preAcceptanceSubBenefitData.preAcceptanceTripRentalCar.reimbursedBy,
					_txtBoxReimbursedByOtherPreTripRentalCar,
					preAcceptanceSubBenefitData.preAcceptanceTripRentalCar.reimbursedByOther, subBenefitFormName,
					PDTConstants.REIMBURSED_BY_OTHER);

			CoreFunctions.clearAndSetText(driver, _textAreaBenefitCommentTripRentalCar, PDTConstants.COMMENT,
					preAcceptanceSubBenefitData.preAcceptanceTripRentalCar.comment);
