...
public class CoreFlex_SharedSteps {
	...
	public void he_has_searched_for_points_based_CoreFlex_policy_on_page(
			String policyStatus, String pageName) throws Throwable {
		viewPolicyPage.searchAndVerifyPolicy(CoreFunctions.getPropertyFromConfig("Assignment_Policy"), pageName);
	}
...
//						CoreConstants.FAIL, PDTConstants.POINTS_BASED_FLEX_POLICY));
	...
	public void he_has_verified_Policy_Benefits_SubBenefits_details_of_version_Policy_matches_with_policy_selections(
			String newPolicyVersion, String newPolicyStatus, String oldPolicyVersion)
			throws Throwable {
		...
		Assert.assertTrue(
				coreFlexPolicyBenefitsCategoriesPage.verifySelectedBenefitsPostVersioningCloning(CoreFunctions.getPropertyFromConfig("CoreFlex_Policy_BenefitType"),
...
//		CoreConstants.TIME_BEFORE_ACTION = new Date().getTime();
//		Assert.assertTrue(
//				coreFlexPolicyBenefitsCategoriesPage.verifyBenefitsDisplayedOnLeftNavigation(CoreFunctions.getPropertyFromConfig("CoreFlex_Policy_BenefitType"),
//						CoreFunctions.getPropertyFromConfig("CoreFlex_Policy_RequiredFor"), "0"),
//				MessageFormat.format(
...
//				CoreFunctions.getPropertyFromConfig("CoreFlex_Policy_BenefitType"), coreFlexDuplicateHousingBenefitsPage, coreFlexLumpSumBenefitsPage,
...
//				coreFlexHouseHuntingTripBenefitsPage, CoreFunctions.getPropertyFromConfig("CoreFlex_Policy_RequiredFor"), "0"),
...
//		generalInfoPage.fillOtherMandatoryFieldsPostVersioning();
	...
	public void he_has_filled_Benefit_SubBenefit_details_after_adding_a_new_Benefit_on_Policy_Benefit_Categories_page() throws Throwable {
		...
		Reporter.addStepLog("<b>Total time taken to navigate to <i>Selected Benefits</i> page is :"
				+ CoreFunctions.calculatePageLoadTime(CoreConstants.TIME_BEFORE_ACTION, CoreConstants.TIME_AFTER_ACTION)
				+ " Seconds </b>");
		Assert.assertTrue(coreFlexPolicyBenefitsCategoriesPage.selectAndFillAddedBenefits(CoreFunctions.getPropertyFromConfig("CoreFlex_Policy_BenefitType"),
	...
	public void he_has_deselected_an_existing_Benefit_on_Policy_Benefit_Categories_page()
			throws Throwable {
		flexPolicySetupPage.clickLeftNavigationMenuOfPage(COREFLEXConstants.POLICY_BENEFIT_CATEGORIES);
		CoreConstants.TIME_BEFORE_ACTION = new Date().getTime();
		Assert.assertTrue(
	...
	public void he_has_clicked_on_button_after_removing_a_Subbenefit_from_an_added_Benefit(String buttonName) throws Throwable {
		flexPolicySetupPage.clickLeftNavigationMenuOfPage(COREFLEXConstants.POLICY_BENEFIT_CATEGORIES);
		CoreConstants.TIME_BEFORE_ACTION = new Date().getTime();
		Assert.assertTrue(
				coreFlexPolicyBenefitsCategoriesPage.verifyPageNavigation(COREFLEXConstants.POLICY_BENEFIT_CATEGORIES),
		...
		Reporter.addStepLog("<b>Total time taken to navigate to <i>Blueprint - Policy Benefit Categories</i> page is :"
				...
				+ " Seconds </b>");
		Assert.assertTrue(
				coreFlexPolicyBenefitsCategoriesPage.deselectSelectedSubBenefit(CoreFunctions.getPropertyFromConfig("CoreFlex_Policy_BenefitType")),
	...
	public void he_has_clicked_on_button_after_adding_a_SubBenefit_to_an_added_Benefit(String buttonName) throws Throwable {
		flexPolicySetupPage.clickLeftNavigationMenuOfPage(COREFLEXConstants.POLICY_BENEFIT_CATEGORIES);
		CoreConstants.TIME_BEFORE_ACTION = new Date().getTime();
		Assert.assertTrue(
				coreFlexPolicyBenefitsCategoriesPage.verifyPageNavigation(COREFLEXConstants.POLICY_BENEFIT_CATEGORIES),
		...
		Reporter.addStepLog("<b>Total time taken to navigate to <i>Blueprint - Policy Benefit Categories</i> page is :"
				...
				+ " Seconds </b>");
		Assert.assertTrue(
				coreFlexPolicyBenefitsCategoriesPage.selectAndFillUnSelectedSubBenefit(CoreFunctions.getPropertyFromConfig("CoreFlex_Policy_BenefitType")),
				MessageFormat.format(COREFLEXConstants.FAILED_TO_DESELECT_SUBBENEFIT_FROM_SELECTED_BENEFIT_PAGE,
						CoreConstants.FAIL));
