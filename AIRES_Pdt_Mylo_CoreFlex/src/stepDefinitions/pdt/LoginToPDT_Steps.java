...
public class LoginToPDT_Steps {
	...
	public void he_is_on_Policy_App_login_page() {
		loginPage.openApplication();
	}

	@Given("^he enters below login credentials in Username, Password fields$")
	public void he_enters_below_login_credentials_in_Username_Password_fields(DataTable loginData) {
	...
	public void he_should_be_redirected_to_page(String pageName) {
	...
	public void below_userName_should_be_displayed_on_page(String pageName, DataTable dataTable) {
	...
	@Given("^he has logged into 'Aires Policy Tool' application as a \"([^\"]*)\" user$")
	public void he_has_logged_into_Aires_Policy_Tool_application_as_a_user(String userType) {
	...
	public void he_enters_and_in_username_and_password_field(String userName, String password) {
		loginPage.enterLoginCredentials(userName, password);
	}

	@Then("^below \"([^\"]*)\" should be displayed on \"([^\"]*)\" page$")
	public void below_should_be_displayed_on_page(String userName, String pageName) {
	...
	public void policies_should_be_displayed_on_page(String pageName) {
